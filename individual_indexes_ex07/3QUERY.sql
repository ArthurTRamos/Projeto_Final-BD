...
SELECT
	...
	ROUND((AVA.Classificacao_Didatica + AVA.Classificacao_Material_Apoio
	 + AVA.Classificacao_Conteudo + AVA.Classificacao_Infraestrutura)/4.0, 2) AS media_das_notas
FROM
	Avaliacao AVA
JOIN
...
WHERE
	ROUND((AVA.Classificacao_Didatica + AVA.Classificacao_Material_Apoio
	 + AVA.Classificacao_Conteudo + AVA.Classificacao_Infraestrutura)/4.0, 2) > 4.0;
